...
// 🆕 AMPLIADO — se agrega 'bitacora' (sub-fase 1c del Banco de
// Ideas: el "Repositorio de Evidencias" de la Bitácora Diaria).
// Reutiliza EXACTAMENTE el mismo sistema de fotos que ya usan
// Incidencias/Actas/Casas — no se duplica infraestructura de subida
// ni de almacenamiento. referencia_id = el id del evento de bitácora
// (bitacora_eventos.id).
const LIMITES = {
  ...
  bitacora: 8,      // hasta 8 fotos por registro de bitácora
};
 ...
 * - foto: el archivo
 * - contexto: 'incidencia' | 'acta' | 'casa' | 'bitacora'
